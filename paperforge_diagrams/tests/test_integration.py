...
class TestPDFOutput:
    def test_er_diagram_produces_pdf(self) -> None:
        er = pd.ERDiagram(width=450, height=220, caption="ER Integration Test")
    ...
    def test_flowchart_produces_pdf(self) -> None:
        fc = pd.Flowchart(width=300, height=280)
    ...
    def test_class_diagram_produces_pdf(self) -> None:
        cd = pd.ClassDiagram(width=420, height=220)
    ...
    def test_layered_stack_produces_pdf(self) -> None:
        ls = pd.LayeredStack(width=300, height=220, caption="OSI Model")
    ...
    def test_all_diagrams_in_one_pdf(self) -> None:
        ...
        er = pd.ERDiagram(width=400, height=180)
        ...
        fc = pd.Flowchart(width=300, height=200)
        ...
        td = pd.TimingDiagram(width=350, height=130)
        td.clock("CLK", period=20.0, cycles=5)

        ls = pd.LayeredStack(width=300, height=200)
    ...
    def test_light_theme_produces_pdf(self) -> None:
        er = pd.ERDiagram(width=400, height=180, theme=pd.LIGHT)
