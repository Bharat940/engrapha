...
class ERDiagram(DiagramBase):
    ...
    def auto_layout_nodes(self) -> None:
        ...
        coords = auto_layout_graph(node_names, edges, self.width, self.height)
        for e in self._entities:
    ...
    def build(self) -> None:
        ...
        for conn in self._connections:
            ...
            if dist > 36.0:
                ...
                card_from_x = ex1 + ux * 18.0
                card_from_y = ey1 + uy * 18.0
                card_to_x = ex2 - ux * 18.0
                card_to_y = ey2 - uy * 18.0
            else:
