...
from engrapha_diagrams.sequence import SequenceDiagram
...
class TestSequenceDiagramBuilder:
    ...
    def test_row_increments(self) -> None:
        ...
        from engrapha_diagrams.sequence import _SeqMessage
    ...
    def test_divider_added(self) -> None:
        seq = SequenceDiagram(width=400, height=200)
        from engrapha_diagrams.sequence import _SeqDivider
