...
# #############################################################################
en.part_box("QUESTION 1 -- CONSTITUTION & SALIENT FEATURES")
...
en.section("Meaning of Constitution & Constitutional Law")
en.definition(
...
en.section("Meaning of Constitutionalism")
en.definition(
...
en.section("Comparison: Constitution vs Constitutionalism")
en.info_table(
...
en.br()
en.chap_box("Q1(b) [4 Marks] -- Company Rule in India (1773-1785)\n" "(June 2022)")

en.section("Historical Context of Company Rule")
en.body(
...
en.section("Regulating Act of 1773")
en.bullet(
    [
...
en.section("Pitt's India Act of 1784")
en.bullet(
    [
...
en.section("First Cabinet of Free India (1947)")
en.body(
...
en.section("Factors Influencing the Development of the Indian Constitution")
en.body(
...
en.section("Salient Features of the Constitution")
en.body(
...
en.section("Original Jurisdiction of the Supreme Court (Article 131)")
en.definition(
...
en.body("This exclusive jurisdiction covers disputes between:")
en.bullet(
    [
...
en.section("Other Jurisdictions of the Supreme Court")
en.info_table(
...
en.section("Constitution of the High Court")
en.definition(
...
en.section("Qualifications of a High Court Judge (Article 217(2))")
en.body(
...
# #############################################################################
en.part_box("QUESTION 2 -- FUNDAMENTAL RIGHTS, DUTIES & DPSP")
...
en.section("Universal Adult Franchise (Article 326)")
en.definition(
...
en.section("Fundamental Duties Scheme (Article 51A)")
en.definition(
...
en.section("Swaran Singh Committee (1976) & Verma Committee (1999)")
en.body(
...
en.section("Enforceability and Significance of Fundamental Duties (10 Marks)")
en.definition(
...
en.section("Five Key Elements of the Preamble")
en.info_table(
...
en.section("Is the Preamble Part of the Constitution?")
en.body("The legal status of the Preamble evolved through landmark cases:")
en.bullet(
    [
...
en.section("Article 32 vs Article 226 Writ Jurisdiction")
en.info_table(
...
en.section("DPSPs: Welfare State Objectives")
en.definition(
...
en.section("Classification of DPSPs")
en.info_table(
...
en.section("Scheme & Classification of Fundamental Rights")
en.body(
...
en.section("FR vs DPSP Interrelationship")
en.body(
...
# #############################################################################
en.part_box("QUESTION 3 -- GOVERNMENT ORGANS, LOK SABHA & RAJYA SABHA")
...
en.section("Three Organs of the Indian Government")
en.body(
...
en.section("Judicial Powers of the President of India (Article 72)")
en.body(
...
en.section("Role & Functions of the Cabinet Secretariat")
en.definition(
...
en.section("President of India: Election and Impeachment")
en.definition(
...
en.section("Vice President of India: Election and Removal")
en.definition(
...
en.section("Centre-State Legislative relations (Articles 245-255)")
en.body("Legislative powers are divided into three lists under the Seventh Schedule:")
en.bullet(
    [
...
en.body("<b>Note:</b> Residuary powers of legislation are vested in Parliament (Article 248).")

en.section("Centre-State Administrative & Financial Relations")
en.body(
...
en.section("Comparison: Lok Sabha vs Rajya Sabha")
en.info_table(
...
en.section("Federal vs Unitary Features of the Indian Constitution")
en.body(
...
# #############################################################################
en.part_box("QUESTION 4 -- AMENDMENTS, EMERGENCY & LEGISLATIVE PROCESS")

en.chap_box(
    "Q4(a) [3 Marks] -- Zero Hour & Emergency Types\n" "(May-June 2024 | May-June 2023)"
)

en.section("Zero Hour in Indian Parliament")
en.definition(
...
en.section("Types of Emergency in the Indian Constitution (10 Marks)")
en.body(
...
en.section("President's Rule (Art. 356) vs Governor's Rule")
en.body(
...
en.section("Comparison: National Emergency (Art. 352) vs President's Rule (Art. 356)")
en.info_table(
...
en.section("Comparison: Ordinary Bill vs Money Bill")
en.info_table(
...
en.section("Financial Emergency (Article 360) (10 Marks)")
en.definition(
...
en.body("The passage of an Ordinary Bill involves five key stages:")

# Diagram: LayeredStack for passage of a bill
stack_bill = ed.LayeredStack(
    width=en.CW * 0.75,
    height=250,
    theme=diag_theme,
...
en.story.extend(stack_bill.as_flowable())
en.sp(4)
...
en.section("Delegated Legislation (Subordinate Legislation)")
en.definition(
...
en.section("Collective Responsibility of the Council of Ministers (Article 75(3))")
en.definition(
...
en.section("Amendment Procedure under Article 368")
en.body(
...
en.section("Parliamentary Committees: PAC and Estimates Committee")
en.body(
...
# #############################################################################
en.part_box("QUESTION 5 -- LOCAL SELF GOVERNMENT, CITIZENSHIP & ENVIRONMENT")
...
en.section("Methods of Termination of Indian Citizenship")
en.body(
...
en.section("Recommendations of Balwant Rai Mehta Committee (1957)")
en.body(
...
en.section("State Finance Commission (Article 243I)")
en.definition(
...
en.section("Article 21: Right to Life and Personal Liberty (10 Marks)")
en.definition(
...
en.section("Implied Rights under Article 21")
en.body(
...
en.section("Benefits of Decentralization of Power")
en.body(
...
en.section("Critical Analysis & Major Challenges Confronting LSGs")
en.body(
...
en.section("Article 19: Six Freedoms and Permissible Restrictions")
en.body(
...
en.section("Article 14: Fundamental Right to Equality (10 Marks)")
en.definition(
...
en.section("Role of NGOs in Environmental Protection & Constraints")
en.body(
...
#  BUILD DOCUMENT
# =============================================================================
en.build_doc("IC_PYQ_Answers.pdf")
