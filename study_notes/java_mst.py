...
pn.section("Key Components Explained")
pn.bullet(
    [
...
pn.section("Java Execution Process")
pn.bullet(
    [
...
# -- Q2 [4 Marks] -------------------------------------------------------------
pn.bookmark("MST-I Q2")
pn.chap_box("Q2 [4 Marks] -- Loops in Java with Examples\n(MST-I, March 2026)")
...
pn.subsection("4. Enhanced for-each Loop")
pn.body(
...
pn.subsection("Expected Output (all four loops combined)")
pn.code_block(
    """\
$ java LoopDemo
while: 1
...
# -- Q3 [8 Marks] -------------------------------------------------------------
pn.bookmark("MST-I Q3")
pn.chap_box("Q3 [8 Marks] -- Data Types in Java\n(MST-I, March 2026)")
...
pn.section("1. Primitive Data Types")
pn.body(
...
pn.subsection("Integer Types: byte, short, int, long")
pn.body(
...
pn.subsection("Floating-Point Types: float, double")
pn.body(
...
pn.section("2. Non-Primitive (Reference) Data Types")
pn.body(
...
pn.section("Complete Code Example -- All Primitive Types")
pn.code_block(
    """\
...
# -- Q4 [3 Marks] -------------------------------------------------------------
pn.bookmark("MST-I Q4")
pn.chap_box("Q4 [3 Marks] -- Multi-Threading in Java\n(MST-I, March 2026)")

pn.section("What is Multi-Threading?")
pn.body(
...
pn.subsection("Method 1: Extending Thread Class")
pn.code_block(
    """\
...
pn.subsection("Method 2: Implementing Runnable Interface")
pn.code_block(
    """\
...
pn.subsection("Expected Output (thread name may vary by OS scheduler)")
pn.code_block(
    """\
$ java ThreadDemo
...
# -- Q5 [4 Marks] -------------------------------------------------------------
pn.bookmark("MST-I Q5")
pn.chap_box("Q5 [4 Marks] -- Constructors in Java\n(MST-I, March 2026)")
...
pn.subsection("Types of Constructors")
pn.bullet(
    [
...
pn.section("Complete Example: Constructor Types")
pn.code_block(
    """\
...
# -- Q6 [8 Marks] -------------------------------------------------------------
pn.bookmark("MST-I Q6")
pn.chap_box("Q6 [8 Marks] -- Java Packages: Creation and Usage\n(MST-I, March 2026)")
...
pn.section("Creating a User-Defined Package")
pn.body(
...
pn.subsection("Step 1: Create the Package Directory and Source File")
pn.body("Create file: <b>mypackage/Greeting.java</b>")
pn.code_block(
    """\
...
pn.subsection("Step 2: Compile with -d Flag")
pn.body(
...
pn.subsection("Step 3: Create a Class in Another Package")
pn.body("Create file: <b>MainApp.java</b> (in the root/default package)")
pn.code_block(
    """\
// File: MainApp.java
...
pn.subsection("Step 4: Compile and Run MainApp")
pn.code_block(
    """\
javac MainApp.java
java MainApp
...
pn.section("Access Control with Packages")
pn.info_table(
    [
        "Access Modifier",
        "Same Class",
...
pn.section("Applet Lifecycle Methods")
pn.body(
...
pn.section("Complete Java Applet Example")
pn.code_block(
    """\
...
pn.subsection("Expected Console Output & GUI Display")
pn.code_block(
    """\
...
pn.section("Applet vs Standalone Application -- Comparison")
pn.info_table(
...
pn.section("Complete AWT Student Registration Form")
pn.code_block(
    """\
import java.awt.*;
...
pn.subsection("Expected Console Output (when buttons are clicked)")
pn.code_block(
    """\
...
pn.section("Component Explanations")
pn.subsection("Frame")
pn.body(
...
pn.subsection("Button and ActionListener")
pn.body(
...
pn.section("1. Component (java.awt.Component)")
pn.body(
...
pn.section("2. Container (java.awt.Container) -- extends Component")
pn.body(
...
pn.section("3. Panel (java.awt.Panel) -- extends Container")
pn.body(
...
pn.section("4. Frame (java.awt.Frame) -- extends Window extends Container")
pn.body(
...
pn.section("Code Example: Frame with Panel")
pn.code_block(
    """\
import java.awt.*;
import java.awt.event.*;
...
pn.subsection("Expected Output (console + GUI window)")
pn.code_block(
    """\
...
pn.section("6-Step JDBC Connection Process")
pn.info_table(
...
pn.subsection("Step 1: Load the JDBC Driver")
pn.body(
...
pn.subsection("Step 2: Establish a Connection")
pn.body(
...
pn.subsection("Step 3: Create a Statement")
pn.body(
...
pn.subsection("Steps 4-6: Execute, Process, Close")
pn.body(
...
pn.section("Complete JDBC Code Example -- Remote Database Connection")
pn.code_block(
    """\
import java.sql.*;
...
pn.section("Key JDBC API Methods Explained")
pn.info_table(
...
pn.section("Flow of Event Processing")
pn.bullet(
    [
...
pn.section("Common Event Types and Listener Interfaces")
pn.info_table(
...
pn.section("Complete ActionListener Example")
pn.code_block(
    """\
import java.awt.*;
import java.awt.event.*;
...
pn.subsection("Expected Console Output")
pn.code_block(
    """\
...
pn.section("Anonymous Inner Class Listener (Alternative)")
pn.body(
...
pn.section("SQL: Create and Populate the Table")
pn.body("First, create the database table in MySQL:")
pn.code_block(
    """\
...
pn.section("Complete Java JDBC Program")
pn.code_block(
    """\
import java.sql.*;
...
pn.section("JDBC API Methods -- Detailed Explanation")
pn.info_table(
...
pn.section("Using PreparedStatement -- Safer Query")
pn.body(
...
# #############################################################################
pn.bookmark("MST-I April 2023")
pn.part_box("MST-I -- April 2023  (Session: Jan-June 2023)")
pn.note(
...
# -- 2023-I Q1 [3 Marks] ------------------------------------------------------
pn.bookmark("2023-I Q1")
pn.chap_box(
    "Q1 [3 Marks] -- Single-line and Multi-line Comments in Java\n"
    "(MST-I, April 2023)"
)
pn.section("Types of Comments in Java")
pn.definition(
...
pn.section("Categories of Java Data Types")
pn.definition(
...
pn.section("Option B: Project Day Calculator")
pn.definition(
...
# -- 2023-I Q5 [4 Marks] ------------------------------------------------------
pn.bookmark("2023-I Q5")
pn.chap_box("Q5 [4 Marks] -- Class vs Interface Comparison\n" "(MST-I, April 2023)")
pn.section("Class and Interface -- Comparison")
pn.info_table(
...
pn.bookmark("2023-I Q6")
pn.chap_box(
    "Q6 [8 Marks] -- Polymorphism | OR | Inheritance with All Types\n"
    "(MST-I, April 2023 -- Internal Choice)"
)
pn.section("Option A: Polymorphism in Java (Recommended)")
pn.definition(
...
pn.section("Option B: Inheritance -- All Types in Java")
pn.definition(
...
# #############################################################################
pn.bookmark("MST-II May 2023")
pn.part_box("MST-II -- May 2023  (Session: Jan-June 2023)")
pn.note(
...
# -- 2023-II Q1 [3 Marks] -----------------------------------------------------
pn.bookmark("2023-II Q1")
pn.chap_box(
    "Q1 [3 Marks] -- Attributes of the <applet> HTML Tag\n" "(MST-II, May 2023)"
)
pn.section("The <applet> HTML Tag")
pn.definition(
...
pn.subsection("Output in appletviewer")
pn.code_block(
    """\
...
pn.section("Applet Lifecycle Methods -- Detailed")
pn.info_table(
...
# -- 2023-II Q4 [3 Marks] -----------------------------------------------------
pn.bookmark("2023-II Q4")
pn.chap_box("Q4 [3 Marks] -- Event Delegation Model\n" "(MST-II, May 2023)")
pn.note(
...
pn.section("Event Delegation Model -- Summary")
pn.definition(
...
# -- 2023-II Q5 [4 Marks] -----------------------------------------------------
pn.bookmark("2023-II Q5")
pn.chap_box("Q5 [4 Marks] -- AWT vs Swing -- Differentiation\n" "(MST-II, May 2023)")
pn.section("AWT vs Swing -- Detailed Comparison")
pn.info_table(
...
pn.subsection("Expected Console Output (when 'Show Info' button clicked)")
pn.code_block(
    """\
...
pn.section("Option B: Java Program for Various Graphic Controls")
pn.code_block(
    """\
import java.applet.Applet;
import java.awt.*;
...
pn.subsection("Expected GUI Display")
pn.code_block(
    """\
...
pn.subsection("Graphics Methods Reference")
pn.info_table(
...
# #############################################################################
pn.bookmark("MST-III May 2023")
pn.part_box("MST-III -- May 2023  (Session: Jan-June 2023)")
pn.note(
...
pn.section("Card Deck Program -- 6 Mark Version")
pn.definition(
...
pn.section("Types of Inheritance in Java -- 6 Mark Summary")
pn.info_table(
...
# -- 2023-III Q3 [6 Marks] ----------------------------------------------------
pn.bookmark("2023-III Q3")
pn.chap_box("Q3 [6 Marks] -- Applet Lifecycle with Example\n" "(MST-III, May 2023)")
pn.note(
...
pn.section("Applet Lifecycle -- 6 Mark Summary")
pn.info_table(
...
pn.highlight("init() -> start() -> paint()  [ <--> stop() <--> start() ]  -> destroy()")
pn.code_block(
    """\
import java.applet.Applet;
import java.awt.Graphics;
...
# -- 2023-III Q4 [6 Marks] ----------------------------------------------------
pn.bookmark("2023-III Q4")
pn.chap_box("Q4 [6 Marks] -- AWT vs Swing: Differentiation\n" "(MST-III, May 2023)")
pn.note(
    "This question overlaps with Q5 [4 Marks] MST-II May 2023. "
    "The 6-mark version provides an expanded answer."
)
pn.section("AWT vs Swing -- 6 Mark Answer")
pn.definition(
...
pn.section("JDBC Connectivity -- 6 Mark Answer")
pn.definition(
...
# -- Build ---------------------------------------------------------------------
pn.build_doc("Java_MST_Answers.pdf")
